...
handleSubmit=(e)=>{
e.preventDefault();
axios.post("http://localhost:8080/user",this.state).then((response)=>{this.setState({message:response.data})})
          ...
          <div className="content_rgt">
            <div className="register_sec">
              ...
              <ul>
                ...
                <li><span>Email</span><input onChange={this.handleChange} type="text" placeholder="Enter your email" name='Email'required/></li>
